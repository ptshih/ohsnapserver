Moogle::Application.routes.draw do
  ...
  match ':version/users/:user_id/places', :controller => 'user', :action => 'places', :via => :get # LIST: get all friends for a user (param for degree: 1 or 2)
  ...
  # Places
  # General
  # match ':version/places', :controller => 'place', :action => 'index', :via => :get # LIST: get all places in the database
