Moogle::Application.routes.draw do
  ...
  # Example: curl "http://localhost:3000/v1/places/nearby?distance=25&limit=100&wat=.json"
  ...
  match ':version/moogle/test', :controller => 'moogle', :action =>'test_post_kupos', :via => :post # test post kupo
