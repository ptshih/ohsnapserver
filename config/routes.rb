Moogle::Application.routes.draw do
  ...
  match ':version/users/:user_id/arevents', :controller => 'user', :action => 'arevents', :via => :get # LIST: get all places a user participated at
  ...
  # Actions
  match ':version/events/new', :controller => 'event', :action =>'new', :via => :post # CREATE: create a new kupo
